...
public class CheckHotels extends JFrame implements Runnable{
    ...
    JLabel[] label = new JLabel[]{l1,l2,l3,l4,l5,l6,l7,l8,l9,l10};
     public void run(){
         String[] text=new String[]{"JW Marriott Hotel","Westin hotel"," Novotel hotel","Crowne Plaza hotel","Conrad Hotels","Shangri La hotel"," Premier Inn"," Hyatt hotel","Radisson hotel","The Oberoi Udaivilas hotel"};
